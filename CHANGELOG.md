...
### Features:
 * do not wait for The Lonely AI model to load at startup
 ...
 * add setting: The Lonely AI/Random number generator source: makes it possible to make images generated from a given manual seed consistent across different GPUs
