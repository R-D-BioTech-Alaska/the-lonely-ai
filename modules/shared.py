...
options_templates.update(options_section(('saving-images', "Saving images/grids"), {
    ...
    "samples_filename_pattern": OptionInfo("", "Images filename pattern", component_args=hide_dirs).link("wiki", "https://github.com/R-D-BioTech-Alaska/the-lonely-ai/wiki/Custom-Images-Filename-Name-and-Subdirectory"),
...
options_templates.update(options_section(('saving-to-dirs', "Saving to a directory"), {
    ...
    "directories_filename_pattern": OptionInfo("[date]", "Directory name pattern", component_args=hide_dirs).link("wiki", "https://github.com/R-D-BioTech-Alaska/the-lonely-ai/wiki/Custom-Images-Filename-Name-and-Subdirectory"),
...
options_templates.update(options_section(('sd', "The Lonely AI"), {
    "sd_model_checkpoint": OptionInfo(None, "The Lonely AI checkpoint", gr.Dropdown, lambda: {"choices": list_checkpoint_tiles()}, refresh=refresh_checkpoints),
    "sd_checkpoint_cache": OptionInfo(0, "Checkpoints to cache in RAM", gr.Slider, {"minimum": 0, "maximum": 10, "step": 1}),
    "sd_vae_checkpoint_cache": OptionInfo(0, "VAE Checkpoints to cache in RAM", gr.Slider, {"minimum": 0, "maximum": 10, "step": 1}),
    "sd_vae": OptionInfo("Automatic", "SD VAE", gr.Dropdown, lambda: {"choices": shared_items.sd_vae_items()}, refresh=shared_items.refresh_vae_list).info("choose VAE model: Automatic = use one with same filename as checkpoint; None = use VAE from checkpoint"),
    "sd_vae_as_default": OptionInfo(True, "Ignore selected VAE for the lonely ai checkpoints that have their own .vae.pt next to them"),
    ...
    "CLIP_stop_at_last_layers": OptionInfo(1, "Clip skip", gr.Slider, {"minimum": 1, "maximum": 12, "step": 1}).link("wiki", "https://github.com/R-D-BioTech-Alaska/the-lonely-ai/wiki/Features#clip-skip").info("ignore last layers of CLIP nrtwork; 1 ignores none, 2 ignores one layer"),
...
options_templates.update(options_section(('optimizations', "Optimizations"), {
    ...
    "s_min_uncond": OptionInfo(0, "Negative Guidance minimum sigma", gr.Slider, {"minimum": 0.0, "maximum": 4.0, "step": 0.01}).link("PR", "https://github.com/R-D-BioTech-Alaska/the-lonely-ai/pull/9177").info("skip negative prompt for some steps when the image is almost ready; 0=disable, higher=faster"),
    "token_merging_ratio": OptionInfo(0.0, "Token merging ratio", gr.Slider, {"minimum": 0.0, "maximum": 0.9, "step": 0.1}).link("PR", "https://github.com/R-D-BioTech-Alaska/the-lonely-ai/pull/9256").info("0=disable, higher=faster"),
...
options_templates.update(options_section(('sampler-params', "Sampler parameters"), {
    ...
    'always_discard_next_to_last_sigma': OptionInfo(False, "Always discard next-to-last sigma").link("PR", "https://github.com/R-D-BioTech-Alaska/the-lonely-ai/pull/6044"),
