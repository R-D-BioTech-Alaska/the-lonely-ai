...
def list_models():
    ...
    if shared.cmd_opts.no_download_sd_model or cmd_ckpt != shared.sd_model_file or os.path.exists(cmd_ckpt):
        ...
        model_url = "https://huggingface.co/Inserian/LonelyAIckpnt/resolve/main/LonelyAIRealism.safetensors"
...
def enable_midas_autodownload():
    ...
    # the-lonely-ai-stability-ai hard-codes the midas model path to
        ...
        if self.sd_model is None:
            with self.lock:
                ...
                try:
                    ...
                    errors.display(e, "loading the lonely ai model")
                    print("", file=sys.stderr)
                    print("The lonely ai model failed to load", file=sys.stderr)
                    self.sd_model = None
