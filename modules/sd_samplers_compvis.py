...
samplers_data_compvis = [
    sd_samplers_common.SamplerData('DDIM', lambda model: VanillaTheLonelyAISampler(ldm.models.diffusion.ddim.DDIMSampler, model), [], {"default_eta_is_0": True, "uses_ensd": True}),
    sd_samplers_common.SamplerData('PLMS', lambda model: VanillaTheLonelyAISampler(ldm.models.diffusion.plms.PLMSSampler, model), [], {}),
    sd_samplers_common.SamplerData('UniPC', lambda model: VanillaTheLonelyAISampler(modules.models.diffusion.uni_pc.UniPCSampler, model), [], {}),
]


class VanillaTheLonelyAISampler:
