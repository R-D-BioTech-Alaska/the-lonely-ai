...
parser.add_argument("--ckpt", type=str, default=sd_model_file, help="path to checkpoint of the lonely ai model; if specified, this checkpoint will be added to the list of checkpoints and loaded",)
parser.add_argument("--ckpt-dir", type=str, default=None, help="Path to directory with the lonely ai checkpoints")
...
parser.add_argument("--medvram", action='store_true', help="enable the lonely ai model optimizations for sacrificing a little speed for low VRM usage")
parser.add_argument("--lowvram", action='store_true', help="enable the lonely ai model optimizations for sacrificing a lot of speed for very low VRM usage")
parser.add_argument("--lowram", action='store_true', help="load the lonely ai checkpoint weights to VRAM instead of RAM")
...
parser.add_argument("--opt-channelslast", action='store_true', help="change memory type for the lonely ai to channels last")
