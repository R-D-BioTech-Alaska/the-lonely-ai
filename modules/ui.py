...
def calc_resolution_hires(enable, width, height, hr_scale, hr_resize_x, hr_resize_y):
    ...
    p = processing.TheLonelyAIProcessingTxt2Img(width=width, height=height, enable_hr=True, hr_scale=hr_scale, hr_resize_x=hr_resize_x, hr_resize_y=hr_resize_y)
...
def create_ui():
    ...
    with gr.Blocks(analytics_enabled=False) as train_interface:
        with gr.Row().style(equal_height=False):
            gr.HTML(value="<p style='margin-bottom: 0.7em'>See <b><a href=\"https://github.com/R-D-BioTech-Alaska/the-lonely-ai/wiki/Textual-Inversion\">wiki</a></b> for detailed explanation.</p>")
        ...
        with gr.Row(variant="compact").style(equal_height=False):
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="Train", id="train"):
                    gr.HTML(value="<p style='margin-bottom: 0.7em'>Train an embedding or Hypernetwork; you must specify a directory with a set of 1:1 ratio images <a href=\"https://github.com/R-D-BioTech-Alaska/the-lonely-ai/wiki/Textual-Inversion\" style=\"font-weight:bold;\">[wiki]</a></p>")
                    with FormRow():
    ...
    with gr.Blocks(theme=shared.gradio_theme, analytics_enabled=False, title="The Lonely AI") as demo:
...
def versions_html():
    ...
    return f"""
version: <a href="https://github.com/R-D-BioTech-Alaska/the-lonely-ai/commit/{commit}">{tag}</a>
&#x2000;•&#x2000;
