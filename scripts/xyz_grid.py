...
from modules.processing import process_images, Processed, TheLonelyAIProcessingTxt2Img
...
def apply_styles(p: TheLonelyAIProcessingTxt2Img, x: str, _):
...
class Script(scripts.Script):
    ...
    def run(self, p, x_type, x_values, x_values_dropdown, y_type, y_values, y_values_dropdown, z_type, z_values, z_values_dropdown, draw_legend, include_lone_images, include_sub_grids, no_fixed_seeds, margin_size):
        ...
        if isinstance(p, TheLonelyAIProcessingTxt2Img) and p.enable_hr:
